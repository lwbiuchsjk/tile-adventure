...
- [无限地图_推进进度](tile-advanture-design/进度/无限地图_推进进度.md) — **🔧 L1.2 实装中**（Phase 0 shader 单光源→vec4[8] 多光源 ✅ 2026-06-02 `89d1ad4`；Phase 1-4 据点/多源/昏迷分流待续；L1.2 设计落盘 2026-05-29，L1.1 整体闭环 2026-05-28）
