...
- [无限地图_推进进度](tile-advanture-design/进度/无限地图_推进进度.md) — **🔧 L1.2 实装中**（Phase 0 shader vec4[8] 多光源 ✅ `89d1ad4` + Phase 1 据点机制 ✅ `ef48938`（2026-06-02，据点可攻占/夺回≠胜利修正 §2.1）；Phase 2-4 多源视野/昏迷分流/收口待续）
