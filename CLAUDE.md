...
- [P0_胜负条件重设计](tile-advanture-design/进度/P0_胜负条件重设计_推进进度.md) — X-A 第一阶段跑测验收通过（2026-05-08）；第二阶段 2026-05-11 扩定义为「整局节奏」（胜负终模型 + 周期递增曲线），待与入口 3 同窗开议
