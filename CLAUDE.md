...
- [持久slot战场参与_推进进度](tile-advanture-design/进度/持久slot战场参与_推进进度.md) — 入口 5；L1.1 撤离（394cc0c）+ L1.2 援军（f7b1fcb/03ac4f5）+ L1.3 周期胜利目标（b880656）三份 L1 全落地（桌面跑测验收通过，2026-05-21）；待归档决策
