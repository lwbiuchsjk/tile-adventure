...
- [入口4_探索体验调整](tile-advanture-design/进度/入口4_探索体验调整_推进进度.md) — 第 1 份桌面端跑测通过；HTML 4/5 + 审查待完成

## 已归档

- [入口1_战斗信息传达](tile-advanture-design/进度/入口1_战斗信息传达_推进进度.md) — 1.1 + 1.2 跑测通过（2026-05-09）；1.3 数值平衡走 P1 跟踪
- [P0_胜负条件重设计](tile-advanture-design/进度/P0_胜负条件重设计_推进进度.md) — X-A 第一阶段跑测验收通过（2026-05-08）；第二阶段待与入口 3 同窗开议
